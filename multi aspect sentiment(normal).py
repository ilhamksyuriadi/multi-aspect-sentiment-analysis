...
rawData, rawAvailable, rawAccess, rawInfo, rawTime, rawService, rawComfort, rawSafety = LoadDataset('data cao.xlsx')
...
#Klasifikasi Access
predictAccessU = cross_val_predict(clf, availableDocU, availableLabel, cv=2)
predictAccessU.tolist()
predictAccessB = cross_val_predict(clf, availableDocB, availableLabel, cv=2)
predictAccessB.tolist()
predictAccessUB = cross_val_predict(clf, availableDocUB, availableLabel, cv=2)
